...
@Composable
fun ConfirmBaseDialogWithDescription(
    ...
    val okButtonColor = when (type) {
        ConfirmDialogWithDescriptionType.OK_BUTTON_RED -> colorResource(id = R.color.red)
        ConfirmDialogWithDescriptionType.NO_BUTTON_RED -> colorResource(id = R.color.blue)
        ConfirmDialogWithDescriptionType.NO_RED -> colorResource(id = R.color.blue)
    }

    val noButtonColor = when (type) {
        ConfirmDialogWithDescriptionType.OK_BUTTON_RED -> colorResource(id = R.color.blue)
        ConfirmDialogWithDescriptionType.NO_BUTTON_RED -> colorResource(id = R.color.red)
        ConfirmDialogWithDescriptionType.NO_RED -> colorResource(id = R.color.blue)
    }
